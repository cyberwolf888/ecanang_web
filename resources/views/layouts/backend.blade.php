                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-extended dropdown-notification dropdown-dark" id="header_notification_bar">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <i class="icon-bell"></i>
                            @if(!empty($_transaksi)) <span class="badge badge-success"> {!! count($_transaksi) !!} </span> @endif
                        </a>
                        <ul class="dropdown-menu">
                            <li class="external">
                                <h3><span class="bold">{!! count($_transaksi) !!} transaksi baru</span> </h3>
                            </li>
                            @if(!empty($_transaksi))
                                <li>
                                    <ul class="dropdown-menu-list scroller" style="height: 250px;" data-handle-color="#637283">
                                        @foreach($_transaksi as $_s)
                                            <li>
                                                <a href="{{ route('admin.transaksi.detail',$_s->id) }}">
                                                    <span class="time">{{ date('d F Y',strtotime($_s->created_at)) }}</span>
                                                    <span class="details">
    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu   " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                ...
                <li class="nav-item @if (str_is('*.canang.*', Route::currentRouteName())) active @endif ">
                    <a href="{{ route('admin.canang.manage') }}" class="nav-link ">
                        <i class="icon-rocket"></i>
                        <span class="title">Canang</span>
                    </a>
                </li>
                <li class="nav-item @if (str_is('*.transaksi.*', Route::currentRouteName())) active @endif ">
                    <a href="{{ route('admin.transaksi.manage') }}" class="nav-link ">
                ...
                <li class="nav-item @if (str_is('*.laporan.*', Route::currentRouteName())) active @endif ">
                    <a href="{{ route('admin.laporan.priod') }}" class="nav-link ">
                        <i class="icon-docs"></i>
