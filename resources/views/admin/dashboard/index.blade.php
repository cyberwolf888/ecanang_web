            ...
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                ...
                <div class="widget-thumb-wrap">
                    ...
                    <div class="widget-thumb-body">
                        ...
                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ \App\Models\Transaksi::whereRaw('MONTH(created_at) = '.date('m'))->count() }}">{{ \App\Models\Transaksi::whereRaw('MONTH(created_at) = '.date('m'))->count() }}</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
        ...
        <div class="col-md-4">
            ...
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                ...
                <div class="widget-thumb-wrap">
                    ...
                    <div class="widget-thumb-body">
                        <span class="widget-thumb-subtitle">{{ date('F') }}</span>
                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ \App\Models\Transaksi::select(DB::raw('SUM(total) as profit'))->whereRaw('status = 5 AND MONTH(created_at) = '.date('m'))->first()->profit }}">\App\Models\Transaksi::select(DB::raw('SUM(total) as profit'))->whereRaw('status = 5 AND MONTH(created_at) = '.date('m'))->first()->profit</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
            ...
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                ...
                <div class="widget-thumb-wrap">
                    ...
                    <div class="widget-thumb-body">
                        ...
                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ \App\User::where(['type'=>2])->count() }}">0</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
