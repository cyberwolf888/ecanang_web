            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">Kelola Transaksi</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            ...
                            @foreach($model as $row)
                                <tr>
                                    ...
                                    <td class="center" width="100">
                                        <a href="{{ route('admin.transaksi.detail',$row->id) }}" class="btn green btn-xs"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
